...
class RuleFilter(RootModel[tuple[NetworkService, ...]], IdentifiedBaseModel, frozen=True):
    ...
    root: Annotated[tuple[NetworkService, ...], Len(min_length=1)]
